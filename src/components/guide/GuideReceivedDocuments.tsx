...
interface GuideReceivedDocumentsProps {
  onOfflineSaved?: () => void;
}

const GuideReceivedDocuments = ({ onOfflineSaved }: GuideReceivedDocumentsProps) => {
  ...
  const fetchGuideDocuments = async () => {
    try {
      ...
      // Fetch documents for these trips (group documents OR individual documents for this guide)
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold mb-2">Documente Primite</h2>
        <p className="text-muted-foreground">
          Documente de la administrator pentru circuiturile tale ({documents.length} documente)
        </p>
      </div>
      ...
      {documents.length === 0 ? (
        <Card className="text-center py-8">
          <CardContent className="pt-6">
            ...
            <p className="text-muted-foreground">
              Administratorul nu a încărcat încă documente pentru circuitele tale.
            </p>
          </CardContent>
        </Card>
      ) : (
      ...
      <CardContent className="space-y-3 px-3 sm:px-6">
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          ...
          <div className="flex justify-between">
            <span>Mărime: {formatFileSize(document.file_size)}</span>
        ...
        <div className="flex flex-col gap-2 pt-2">
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              <span className="text-xs">Descarcă</span>
            </Button>
            ...
            {isOffline ? (
              ...
              >
                <span className="text-xs">❌ Șterge Offline</span>
              </Button>
            ) : (
              <Button
                size="sm"
              ...
              >
                {isDownloading ? (
                  ...
                  <span className="text-xs">💾 Salvează Offline</span>
                )}
              </Button>
            )}
          </div>
...
export default GuideReceivedDocuments;